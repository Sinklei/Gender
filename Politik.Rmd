...
in Europa ist der Frauenanteil deutlich höher im vergleich zur gesamten welt. hier liegt er bei 31%. das ist doch super! leider mussten wir aber feststellen, dass es innerhalb der länder deutliche unterschiede gibt. am besten schaut ihr einfach mal selbst! dazu könnt ihr ganz einfach die länder auswählen, die euch am meisten interessieren. mit einem doppelklick schaut ihr euch das land einzeln an.
...
q <- seats_europe %>% 
  ...
  scale_y_continuous(limits = c(0, 50),
                     labels = label_percent(scale = 1, suffix = " %"),
                     expand = c(0,3)) +
  scale_x_continuous(breaks = c(1997, 2000, 2005, 2010, 2015, 2020))
...
##### komplette world reinbringen als linie?
