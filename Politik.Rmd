...
bundestag %>% 
  ggplot() +
  geom_point(aes(y = frauen_anzahl, x = bundestag)
             ) +
  geom_point(aes(y = maenner_anzahl, x = bundestag)
             ) +
  geom_line(aes(y = frauen_anzahl, x = bundestag, group = 1),
            size = 1,
            color = "red"
            ) +
  geom_line(aes(y = maenner_anzahl, x = bundestag, group = 1),
            size = 1,
            color = "blue"
            ) +
  geom_line(aes(y = mitglieder, x = bundestag,  group = 1),
            size = 1,
            color = "black"
            ) +
  scale_x_discrete(breaks = c("1. Bundestag 1949-1953", "20. Bundestag 2021"))
