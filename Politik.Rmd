...
# seats in parliament
* 2020 wie sieht das jetzt gerade so in der welt aus
* was sind die markantesten werte

der schlechteste wert in 2020 ist 0, der beste 61 prozent
mittelwert über die ganze welt in 2020 23,865 prozent (median 23)
Kuba, Rwanda und Ver. Arab. Emirate die einzigen die höher als 50 prozent sind
...
einfach nur zeigen wie es auf der welt ist
...
* seit wann gibt es regularien in deutschland bzgl. Frauenquote
...
o <- seats_2020 %>% filter(percentage >= 50)

view(o)


sw <- seats_2020 %>% filter(country == "Sweden")
